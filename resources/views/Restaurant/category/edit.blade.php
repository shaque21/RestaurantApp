    ...
    <div class="container-fluid">
        <div class="row my-5">
            <div class="col-md-6 offset-md-3">
                ...
                <form method="POST" action="{{ route('food.category.update') }}" id="updateCategoryForm" >
                    @csrf
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control form-control-sm" id="category_name" name="category_name" value="{{ $category->category_name }}" placeholder="Enter Category Name">
                            </div>
                            ...
                            <input type="hidden" name="slug" value="{{ $category->category_slug }}">
